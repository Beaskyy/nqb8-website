    ...
    <section id="engines" className="bg-[#060708] py-20 lg:py-[120px]">
      <Container>
        <FadeInView>
          ...
          <h2 className="font-heading mt-6 text-[48px] font-bold leading-[1.15] tracking-[-1.2%] text-[#F0F2ED] sm:text-[44px] lg:text-[48px] max-w-[760px]">
            Two engines. One infrastructure mindset.
          </h2>
        </FadeInView>
        <p className="mt-8 text-[17px] leading-[150%] text-[#8F999E] sm:text-base max-w-[540px]">
