...
export function About() {
  return (
    <section id="about" className="bg-[#0B0D0F] py-[96px] lg:py-32">
      <Container>
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-[70px]">
          <FadeInView>
            <span className="text-xs font-semibold uppercase tracking-[12%] text-[#0A89FF]">
              WHO WE ARE
            </span>
            <h2 className="font-heading mt-6 text-[48px] font-bold leading-[1.15] tracking-[-1.2%] text-white sm:text-[44px] lg:text-[48px]">
              A Nigerian technology<br />
              institution building<br />
              systems that last.
            </h2>
            <p className="mt-8 text-lg leading-[155%] text-[#9BA4A8] sm:text-base max-w-[560px]">
            ...
            <div className="mt-12 rounded-xl  bg-[#0D1114] py-6 px-[22px]">
              ...
              <blockquote className="max-w-[380px] text-[25px] font-bold text-[#F1F3EF] sm:text-[20px]">
          ...
          <FadeInView direction="left" delay={0.15}>
            <div className="relative w-[600px] h-[520px] w-full overflow-hidden">
              <Image 
                src="/images/code.svg" 
